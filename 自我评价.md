...
- 数据库笔记 [NOTE](https://github.com/Fufupao/Database_SQL/blob/5d8bd78a9ce6503a33124d5ad57b5fcdc96232d4/NOTE/NOTE.md)   <br>✍🏻**Notes：** 包含`课堂`、`作业`与`拓展`笔记
...
- 正确做法(使用**稀疏检索sparse checkout**)：

```bash
git config core.sparseCheckout true

# 在 `.git/info/sparse-checkout` 文件中（如果不存在则创建），添加以下内容：
/*
!/Code_SQL/  
...
- 由于本学期认真完成了课程所有内容并学到了非常有用的知识，在未来求职过程中也许会派上用场，所以我决定为自己的勤劳付出给予满分**40分**！
